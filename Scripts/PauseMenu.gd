...
func _ready() -> void:
	...
	var title := Label.new()
	title.text = Localization.t("pause")
	...
	resume_btn.text = Localization.t("continue")
	...
	restart_btn.text = Localization.t("restart")
	...
	settings_btn.text = Localization.t("settings")
	...
	exit_btn.text = Localization.t("main_menu")
