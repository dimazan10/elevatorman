...
func setup(robot: Node) -> void:
	...
	_bg.color = Color(0.15, 0.15, 0.15, 0.3)
	_bg.modulate.a = 0.0
	add_child(_bg)
	...
	_bar.color = Color(0.8, 0.08, 0.08, 0.85)
	_bar.modulate.a = 0.0
	add_child(_bar)
...
func _on_hp_changed(current: int, max_hp: int) -> void:
	...
	_hide_tween.tween_interval(5.0)
	_hide_tween.tween_method(_modulate_a, 1.0, 0.0, 0.5)


func _modulate_a(a: float) -> void:
	_bg.modulate.a = a
	_bar.modulate.a = a
